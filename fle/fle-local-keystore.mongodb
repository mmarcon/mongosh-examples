...
(function seedDBWithTestData() {
    ...
    const dbName = 'herzog_inc_insurance_local_keystore';
    ...
    const keyMongo = Mongo(process.env.mongodb_connection_string_localhost, {
    ...
    const autoMongo = Mongo(process.mongodb_connection_string_localhost, {
        keyVaultNamespace: 'encryption.__keyVault',
